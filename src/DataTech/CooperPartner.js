...
class CooperPartner extends Component{
  state = {
    cooper_list:[
        {
          cooper_name:"",
  ...
  componentWillReceiveProps(nextProps){
    if(! _.isEqual(this.props.data,nextProps.data)){
      this.setState({
        cooper_list: _.cloneDeep(nextProps.data)?_.cloneDeep(nextProps.data):[]
      })
    }
  }
  add = ()=>{
    if(this._isMounted){
      let cur = _.cloneDeep(this.state.cooper_list)
      cur.push({
        cooper_name:"",
        cooper_attr:[],
        cooper_model:[],
      ...
      this.setState({
        cooper_list: _.cloneDeep(cur)
      },()=>{
        this.props.setCooper_list(this.state.cooper_list)
      })
    }
  }
  remove = (index)=>{
  ...
  render(){
    const agencyList = _.cloneDeep(this.state.cooper_list)
    return (
      <div style={{padding: "0  20px 0 20px"}}>
        <Row gutter={16} style={{marginTop:"20px"}}>
          <Col style={{fontWeight:"bold"}}>国内合作对象</Col>
          {
                  ...
                  <Row gutter={16} style={{marginTop:"20px"}}>
                    <Col sm={12} md={8} lg={8} style={{margin:"10px 0 10px 0"}}>
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <Input
                            value={this.state.cooper_list[index]['cooper_name']}
                      ...
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <Select
                            ...
                            maxTagCount={2}
                            maxTagPlaceholder="...等"
                            value={this.state.cooper_list[index]['cooper_attr']}
                            onChange={(value)=>{this.inputChange(value,index,'cooper_attr')}}
                          >
                      ...
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <Select
                            ...
                            maxTagCount={2}
                            maxTagPlaceholder="...等"
                            value={this.state.cooper_list[index]['cooper_model']}
                      ...
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <Select
                            ...
                            maxTagCount={2}
                            maxTagPlaceholder="...等"
                            value={this.state.cooper_list[index]['cooper_reason']}
                      ...
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <TextArea autosize={{minRows:1, maxRows:2}}
                            value={this.state.cooper_list[index]['cooper_note']}
