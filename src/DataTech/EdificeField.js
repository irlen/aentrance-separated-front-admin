                    ...
                    <Col sm={12} md={12} lg={12} style={{margin: "10px 0 10px 0"}}>
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          ...
                          >
                            <Option value="研发" key="科研技术驱动">科研技术驱动</Option>
                            <Option value="生产" key="共享设备驱动">共享设备驱动</Option>
                            <Option value="办公" key="原材料驱动">原材料驱动</Option>
                            <Option value="检测试验" key="成果转化驱动">成果转化驱动</Option>
                          </Select>
                        </div>
