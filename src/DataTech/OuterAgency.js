...
class OuterAgency extends Component{
  ...
  componentWillReceiveProps(nextProps){
    if(! _.isEqual(this.props.data,nextProps.data)){
      this.setState({
        outer_agency: _.cloneDeep(nextProps.data)?_.cloneDeep(nextProps.data):[]
      })
    }
  }
  add = ()=>{
    if(this._isMounted){
      let cur = _.cloneDeep(this.state.outer_agency)
      cur.push({
        agency_name:"",
        agency_address:"",
        agency_link:[],
      ...
      this.setState({
        outer_agency: _.cloneDeep(cur)
      },()=>{
        this.props.setOuter_agency(this.state.outer_agency)
      })
    }
  }
  remove = (index)=>{
  ...
  render(){
    const agencyList = _.cloneDeep(this.state.outer_agency)
    return (
      <div style={{padding: "0  20px 0 20px"}}>
        <Row gutter={16} style={{marginTop:"20px"}}>
          <Col style={{fontWeight:"bold"}}>国外分支机构</Col>
          {
                  ...
                  <Row gutter={16} style={{marginTop:"20px"}}>
                    <Col sm={12} md={8} lg={8} style={{margin:"10px 0 10px 0"}}>
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <Input
                            value={this.state.outer_agency[index]['agency_name']}
                    ...
                    <Col sm={12} md={8} lg={8} style={{margin:"10px 0 10px 0"}}>
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <Input
                            value={this.state.outer_agency[index]['agency_address']}
                      ...
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <Select
                            ...
                            maxTagCount={1}
                            maxTagPlaceholder="...等"
                            value={this.state.outer_agency[index]['agency_link']}
                      ...
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <Select
                            ...
                            maxTagCount={1}
                            maxTagPlaceholder="...等"
                            value={this.state.outer_agency[index]['agency_reason']}
                      ...
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <TextArea autosize={{minRows:1, maxRows:2}}
                            value={this.state.outer_agency[index]['agency_content']}
                    ...
                    <Col sm={12} md={8} lg={8} style={{margin:"10px 0 10px 0"}}>
                      <div style={{...c0}}>
                        ...
                        <div style={{...c2}}>
                          <TextArea autosize={{minRows:1, maxRows:2}}
                            value={this.state.outer_agency[index]['agency_note']}
