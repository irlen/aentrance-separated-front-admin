...
class DataCompany extends Component{
  ...
  getTotal = (search)=>{
    wyAxiosPost('Enterprise/getEnterpriseCount',{search},(result)=>{
  ...
  getParkList = ()=>{
    const doRequest = ()=>{
      ...
      wyAxiosPost('Enterprise/getEnterpriseList',{current,pageSize,search},(result)=>{
        const responseData = result.data.msg
  ...
  delPark = ()=>{
    ...
    wyAxiosPost('Enterprise/delEnterprise',{ids},(result)=>{
      const responseData = result.data.msg
  ...
  editPark = (id)=>{
    if(this._isMounted){
      this.setState({
        ...
        wyAxiosPost('Enterprise/getEnterpriseById',{id: id},(result)=>{
          const responseData = result.data.msg
          if(this._isMounted){
            this.setState({
          ...
          <Col>
            <div css={{display:"flex"}}>
              ...
              <div css={{flex:"0 0 240px"}}>
                <Button onClick={this.addPark} type="primary"><i className="fa fa-plus-square-o" aria-hidden="true"></i> <span css={{marginLeft:"5px"}}>添加企业</span></Button>
