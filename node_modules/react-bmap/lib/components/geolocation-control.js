...
var GeolocationControl = function (_Control) {
    _inherits(GeolocationControl, _Control);

    function GeolocationControl(args) {
        _classCallCheck(this, GeolocationControl);

        return _possibleConstructorReturn(this, (GeolocationControl.__proto__ || Object.getPrototypeOf(GeolocationControl)).call(this, args));
    }
